...
import com.example.watchprog.Exception.ImageNotFoundException;
...
public class ImageUploadService {
    ...
    @Autowired
    public ImageUploadService(ImageRepository imageRepository, UserRepository userRepository, PostsRepository postRepository) {
